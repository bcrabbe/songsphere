...
1 verbose cli [ 'node', '/usr/local/bin/npm', 'install', 'mongoose' ]
2 info using npm@1.4.28
3 info using node@v0.10.36
4 error Failed to parse json
4 error Unexpected token }
5 error File: /Users/ben/Documents/csMSc/web/site/app/package.json
...
7 error System Darwin 14.0.0
8 error command "node" "/usr/local/bin/npm" "install" "mongoose"
9 error cwd /Users/ben/Documents/csMSc/web/site/app/node_modules
10 error node -v v0.10.36
11 error npm -v 1.4.28
12 error file /Users/ben/Documents/csMSc/web/site/app/package.json
